...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (25*60)    // (seconds) Time without extruder movement to trigger protection
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_MIN_BOARD_TEMP 75  // (°C) Turn on the fan if the board reaches this temperature
...
//
#define SAVED_POSITIONS 8         // Each saved position slot costs 12 bytes
